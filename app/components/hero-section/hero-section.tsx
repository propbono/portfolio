...
export const HeroSection = () => {
  return (
    <Section>
      <Container className="grid grid-cols-1 items-center justify-between gap-x-10 md:grid-cols-5 md:py-16">
        ...
        <h1 className="mb-6 w-full font-logo text-4xl font-bold leading-snug text-primary-dark dark:text-primary-light md:col-span-3 md:row-span-1">
          Making the Web a{" "}
          <span className="text-primary-accent">More Beautiful Place</span>, One
          Site at a Time.
        </h1>
